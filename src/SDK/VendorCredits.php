...
class VendorCredits extends BaseClass
{
    ...
    public function create_a_vendor_credit($data = [])
    {
        $url = $this->replaceVariables(
            "https://books.zoho.com/api/v3/vendorcredits?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    /**
     * Convert to open
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/status/open?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Void vendor credit
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/status/void?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/submit?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/approve?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/bills?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/bills/${vendor_credit_bill_id}?organization_id={{ORGANIZATION_ID}}
     * Method: DELETE
     * @param $vendorcreditid
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/refunds?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/refunds/${vendor_credit_refund_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $vendorcreditid
     ...
     * URL: https://books.zoho.com/api/v3/vendorcredits/refunds?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * Headers:
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://books.zoho.com/api/v3/vendorcredits/refunds?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["query"] = [
    ...
    /**
     * Add a comment
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $vendorcreditid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Delete a comment
     * URL: https://books.zoho.com/api/v3/vendorcredits/${vendor_credit_id}/comments/${comment_id}?organization_id={{ORGANIZATION_ID}}
     * Method: DELETE
     * @param $vendorcreditid
     * @param $commentid
     * Headers:
