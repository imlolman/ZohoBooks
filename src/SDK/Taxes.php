...
class Taxes extends BaseClass
{
    /**
     * Create a tax
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxes?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_tax($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxes?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
    ...
    /**
     * Update a tax
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxes/${tax_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $taxid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxes/" .
                $taxid .
    ...
    /**
     * Update a tax group
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxgroups/${tax_group_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $taxgroupid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxgroups/" .
                $taxgroupid .
                "?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
    ...
    /**
     * Create a tax group
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxgroups?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxgroups?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxauthorities?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxauthorities?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxauthorities/${tax_authority_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    public function update_a_tax_authority__us_and_ca_edition_only_(
        ...
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxauthorities/" .
                $taxauthorityid .
                "?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxexemptions?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxexemptions?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxexemptions/${tax_exemption_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    public function update_a_tax_exemption__us_edition_only_(
        ...
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/taxexemptions/" .
                $taxexemptionid .
                "?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
