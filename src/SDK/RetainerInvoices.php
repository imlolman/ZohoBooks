...
class RetainerInvoices extends BaseClass
{
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_retainerinvoice($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/" .
                $retainerinvoiceid .
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/status/sent?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $retainerinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/templates/${template_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $retainerinvoiceid
     * @param $templateid
     * Headers:
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/status/void?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $retainerinvoiceid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Mark as draft
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${reatinerinvoice_id}/status/draft?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${reatinerinvoice_id}/submit?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $reatinerinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${reatinerinvoice_id}/approve?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $reatinerinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/email?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $retainerinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/address/billing?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $retainerinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/templates?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * Headers:
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/templates?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["query"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/attachment?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $retainerinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/documents/${document_id}?organization_id={{ORGANIZATION_ID}}
     * Method: DELETE
     * @param $retainerinvoiceid
     * @param $documentid
     * Headers:
    ...
    /**
     * Add comment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $retainerinvoiceid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Update comment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/retainerinvoices/${retainerinvoice_id}/comments/${comment_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $retainerinvoiceid
     * @param $commentid
     * Headers:
