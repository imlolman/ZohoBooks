...
class Currency extends BaseClass
{
    /**
     * Create a Currency
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/currencies?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_currency($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/currencies?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
    ...
    /**
     * Update a Currency
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/currencies/${currency_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $currencyid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/currencies/" .
                $currencyid .
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/currencies/${currency_id}/exchangerates?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $currencyid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/settings/currencies/${currency_id}/exchangerates/${exchange_rate_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $currencyid
