...
class CustomModules extends BaseClass
{
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/${module_name}?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $modulename
     * Headers:
     * @param array $data = []
    ...
    public function create_custom_modules($modulename, $data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/" .
                $modulename .
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/${module_name}/${module_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $modulename
     * @param $moduleid
     * Headers:
