...
class RecurringInvoices extends BaseClass
{
     ...
     * URL: https://books.zoho.com/api/v3/recurringinvoices/${recurring_invoice_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     ...
     * URL: https://books.zoho.com/api/v3/recurringinvoices/${recurring_invoice_id}/status/stop?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $recurringinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/recurringinvoices/${recurring_invoice_id}/status/resume?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $recurringinvoiceid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://books.zoho.com/api/v3/recurringinvoices/${recurring_invoice_id}/templates/${template_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $recurringinvoiceid
     * @param $templateid
     * Headers:
     ...
     * URL: https://books.zoho.com/api/v3/recurringinvoices/${recurring_invoice_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $recurringinvoiceid
     * Headers:
     */
