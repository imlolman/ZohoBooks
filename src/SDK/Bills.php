...
class Bills extends BaseClass
{
    /**
     * Create a bill
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_bill($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
    ...
    /**
     * Update a bill
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/" .
                $billid .
    ...
    /**
     * Void a bill
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/status/void?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Mark a bill as open
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/status/open?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/submit?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Approve a bill
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/approve?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/address/billing?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    /**
     * List bill payments
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/payments?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $billid
     * Headers:
     */
    ...
    /**
     * Apply credits
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/credits?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Delete a payment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/payments/${bill_payment_id}?organization_id={{ORGANIZATION_ID}}
     * Method: DELETE
     * @param $billid
     * @param $billpaymentid
     * Headers:
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/attachment?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Add comment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $billid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Delete a comment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/bills/${bill_id}/comments/${comment_id}?organization_id={{ORGANIZATION_ID}}
     * Method: DELETE
     * @param $billid
     * @param $commentid
     * Headers:
