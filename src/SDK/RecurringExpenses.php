...
class RecurringExpenses extends BaseClass
{
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_recurring_expense($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses/${recurring_expense_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses/" .
                $recurringexpenseid .
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses/${recurring_expense_id}/status/stop?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $recurringexpenseid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses/${recurring_expense_id}/status/resume?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $recurringexpenseid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses/${recurring_expense_id}/expenses?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $recurringexpenseid
     * Headers:
     */
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringexpenses/${recurring_expense_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $recurringexpenseid
     * Headers:
     */
