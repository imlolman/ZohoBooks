...
class RecurringBills extends BaseClass
{
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_recurring_bill($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills/${recurring_bill_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills/" .
                $recurringbillid .
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurring_bills/${recurring_bill_id}?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $recurringbillid
     * Headers:
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurring_bills/" .
                $recurringbillid .
                "?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills/${recurring_bill_id}/status/stop?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $recurringbillid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills/${recurring_bill_id}/status/resume?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $recurringbillid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/recurringbills/${recurring_bill_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $recurringbillid
     * Headers:
     */
