...
class BankTransactions extends BaseClass
{
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_transaction_for_an_account($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/${bank_transaction_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/" .
                $banktransactionid .
    ...
    /**
     * Match a transaction
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/match?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/" .
                $transactionid .
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/${transaction_id}/unmatch?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/exclude?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/restore?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/categorize?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/categorize/expenses?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/${transaction_id}/uncategorize?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/categorize/vendorpayments?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/categorize/customerpayments?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/categorize/creditnoterefunds?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${transaction_id}/categorize/vendorcreditrefunds?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $transactionid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${statement_line_id}/categorize/paymentrefunds?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/api/v3/banktransactions/uncategorized/${statement_line_id}/categorize/vendorpaymentrefunds?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $statementlineid
     * Headers:
     * @param array $data = []
