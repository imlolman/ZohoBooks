...
class TimeEntries extends BaseClass
{
    ...
    /**
     * Update time entry
     * URL: https://books.zoho.com/api/v3/projects/timeentries/${time_entry_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $timeentryid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://books.zoho.com/api/v3/projects/timeentries/" .
                $timeentryid .
    ...
    /**
     * Start timer
     * URL: https://books.zoho.com/api/v3/projects/timeentries/${time_entry_id}/timer/start?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $timeentryid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Stop timer
     * URL: https://books.zoho.com/api/v3/projects/timeentries/timer/stop?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://books.zoho.com/api/v3/projects/timeentries/timer/stop?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
    ...
    /**
     * Get timer
     * URL: https://books.zoho.com/api/v3/projects/timeentries/runningtimer/me?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * Headers:
     */
    ...
    {
        $url = $this->replaceVariables(
            "https://books.zoho.com/api/v3/projects/timeentries/runningtimer/me?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["query"] = [
