...
class Projects extends BaseClass
{
    /**
     * Create a project
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_a_project($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
    ...
    /**
     * Update project
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $projectid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Activate project
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/active?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $projectid
     * Headers:
     * @param array $data = []
     ...
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/inactive?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $projectid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Clone project
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/clone?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $projectid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Assign users
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/users?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $projectid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Invite user
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/users/invite?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $projectid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Update user
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/users/${user_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $projectid
     * @param $userid
     * Headers:
    ...
    /**
     * Post comment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/comments?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $projectid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Delete comment
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/comments/${comment_id}?organization_id={{ORGANIZATION_ID}}
     * Method: DELETE
     * @param $projectid
     * @param $commentid
     * Headers:
    ...
    /**
     * List invoices
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/projects/${project_id}/invoices?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $projectid
     * Headers:
     */
