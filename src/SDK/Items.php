...
class Items extends BaseClass
{
    /**
     * Create an Item
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/items?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * Headers:
     * @param array $data = []
     */
    public function create_an_item($data = [])
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/items?organization_id={{ORGANIZATION_ID}}"
        );
        $options = [];
        $options["headers"] = [];
        $options["form_params"] = [
    ...
    /**
     * Update an item
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/items/${item_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
     * @param $itemid
     * Headers:
     * @param array $data = []
    ...
    {
        $url = $this->replaceVariables(
            "https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/items/" .
                $itemid .
    ...
    /**
     * Mark as active
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/items/${item_id}/active?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $itemid
     * Headers:
     * @param array $data = []
    ...
    /**
     * Mark as inactive
     * URL: https://{{ZOHO_BOOKS_DOMAIN}}/books/v3/items/${item_id}/inactive?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $itemid
     * Headers:
     * @param array $data = []
