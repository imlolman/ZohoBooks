...
class ContactPersons extends BaseClass
{
     ...
     * URL: https://books.zoho.com/api/v3/contacts/contactpersons/${contact_person_id}?organization_id={{ORGANIZATION_ID}}
     * Method: PUT
    ...
    {
        $url = $this->replaceVariables(
            "https://books.zoho.com/api/v3/contacts/contactpersons/" .
                $contactpersonid .
     ...
     * URL: https://books.zoho.com/api/v3/contacts/${contact_id}/contactpersons?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $contactid
     * Headers:
     */
     ...
     * URL: https://books.zoho.com/api/v3/contacts/${contact_id}/contactpersons/${contact_person_id}?organization_id={{ORGANIZATION_ID}}
     * Method: GET
     * @param $contactid
     * @param $contactpersonid
     * Headers:
     ...
     * URL: https://books.zoho.com/api/v3/contacts/contactpersons/${contact_person_id}/primary?organization_id={{ORGANIZATION_ID}}
     * Method: POST
     * @param $contactpersonid
     * Headers:
     * @param array $data = []
